...
if __package__ is None or __package__ == "":
    ...
    from src_lbbd.lbbd_workflow import run_lbbd
else:
    from .lbbd_workflow import run_lbbd
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the LBBD formulation for the EV charging infrastructure planning model."
    )
    ...
    parser.add_argument("--preset", choices=["small_validation", "full_default", "full_strict"], default=None)
    ...
    parser.add_argument("--disable-pv", action="store_true", help="Disable PV decisions for diagnostic or ablation runs.")
    parser.add_argument("--disable-bess", action="store_true", help="Disable BESS decisions for diagnostic or ablation runs.")
